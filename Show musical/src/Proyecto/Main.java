...
public class Main {
	...
	public static void main(String[] args) {
		...
		SandraMihanovich.addIdioma("Español");
		...
		Cancion temaTrap = new Cancion("TrapSong", "Español");
		...
		Cancion Cualquiera = new Cancion("Cualquiera", "Español");
		...
		Cancion temaFinal = new CancionFinal("TemaFinal", "Español", 2);
